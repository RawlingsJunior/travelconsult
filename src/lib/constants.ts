export const COUNTRIES = [
    ...
    "Central African Republic", "Chad", "Comoros", "Congo (Republic of)", "Congo (Democratic Republic of)",
    "Djibouti", "Egypt", "Equatorial Guinea", "Eritrea", "Eswatini (Swaziland)", "Ethiopia", "Gabon",
    "Gambia", "Ghana", "Guinea", "Guinea-Bissau", "Ivory Coast (Côte d’Ivoire)", "Kenya", "Lesotho",
